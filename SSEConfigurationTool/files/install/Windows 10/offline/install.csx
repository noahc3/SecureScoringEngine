...
if (Directory.Exists("C:\\SSE\\SSEBackend")) Directory.Delete("C:\\SSE\\SSEBackend", true);
...
File.Move(readmePath, "C:\\SSE\\SSEBackend\\config\\runtimes\\offline\\readme.bin");
...
return "C:\\SSE\\SSEBackend\\config\\runtimes\\offline\\scoring.zip";